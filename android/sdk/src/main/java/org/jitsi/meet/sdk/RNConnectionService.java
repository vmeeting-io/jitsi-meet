...
/**
 * The react-native side of Vmeeting's {@link ConnectionService}. Exposes
 * the Java Script API.
 *
 * @author Pawel Domas
 */
...
class RNConnectionService extends ReactContextBaseJavaModule {
     ...
     *
     * @param callUUID - unique call identifier assigned by Vmeeting to
     *        a conference call.
     * @param handle - a call handle which by default is Vmeeting room's URL.
