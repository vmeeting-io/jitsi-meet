...
import { isHost } from './react/features/base/jwt/functions';
import {
...
import { toggleSTT } from './react/features/speech-to-text/actions';
...
export default {
    ...
    _setupListeners() {
        ...
        room.on(JitsiConferenceEvents.NOTIFY_BIRTHDAY_HAT_ON,
            (nick, from) => {
                APP.store.dispatch(showNotification({
                    descriptionArguments: { initiator: nick , participant: getLocalParticipant(APP.store.getState())?.name },
