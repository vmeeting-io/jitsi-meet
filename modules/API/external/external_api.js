...
export default class JitsiMeetExternalAPI extends EventEmitter {
    /**
     * Constructs new API instance. Creates iframe and loads Vmeeting in it.
     *
     * @param {string} domain - The domain name of the server that hosts the
     * conference.
    ...
    /**
     * Getter for the large video element in Vmeeting.
     *
    ...
    /**
     * Getter for participant specific video element in Vmeeting.
     *
     ...
     * {@code readyToClose} - all hangup operations are completed and Vmeeting
    ...
    /**
     * Removes the listeners and removes the Vmeeting frame.
     *
     * @returns {void}
     */
    dispose() {
    ...
    /**
     * Returns the iframe that loads Vmeeting.
     *
