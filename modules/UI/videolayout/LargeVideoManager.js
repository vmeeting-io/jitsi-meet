...
import { DEFAULT_FILMSTRIP_WIDTH, FILMSTRIP_BREAKPOINT } from '../../../react/features/filmstrip/constants';
...
import { isWhiteboardVisible } from '../../../react/features/whiteboard/functions';
...
export default class LargeVideoManager {
    ...
    updateContainerSize(width, height) {
        ...
        if (resizableFilmstrip && visible && (
            (whiteboardVisible && filmstripWidth.current >= DEFAULT_FILMSTRIP_WIDTH) ||
            (!whiteboardVisible && filmstripWidth.current >= FILMSTRIP_BREAKPOINT)
        )) {
