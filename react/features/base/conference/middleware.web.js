...
MiddlewareRegistry.register(store => next => action => {
    ...
    case CONFERENCE_FAILED: {
        ...
        if (errorName === JitsiConferenceErrors.CONFERENCE_DESTROYED) {
            ...
            dispatch(hangup(true, i18next.t(titlekey || `dialog.${reason || errorName}`)));
        } else if (errorName === JitsiConferenceErrors.CONFERENCE_MAX_USERS) {
            dispatch(hangup(true, i18next.t('dialog.maxUsersLimitReached')));
            break;
        }
