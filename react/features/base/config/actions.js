...
/**
 * Signals that the configuration (commonly known in Vmeeting as config.js)
...
/**
 * Signals that a configuration (commonly known in Vmeeting as config.js)
...
/**
 * Stores a specific Vmeeting config.js object into {@code localStorage}.
 *
 * @param {string} baseURL - The base URL from which the config.js was
 * downloaded.
 * @param {Object} config - The Vmeeting config.js to store.
 * @returns {Function}
 */
