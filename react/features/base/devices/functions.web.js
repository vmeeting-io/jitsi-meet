 ...
 */
export function filterIgnoredDevices(devices: Object[] = []) {
...
*/
export function areDevicesDifferent(devices1: Object[] = [], devices2: Object[] = []) {
 ...
 * @returns {string}
 */
function devicesToStr(devices?: Object[]) {
 ...
 * @returns {void}
 */
export function logDevices(devices: Object[], title = '') {
