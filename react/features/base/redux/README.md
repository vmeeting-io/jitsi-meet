Vmeeting - redux state persistence
====================================
Vmeeting has a persistence layer that persists specific subtrees of the redux
...
When it's done, Vmeeting will automatically persist these subtrees and
