...
const DialogWithTabs = ({
    ...
    const onTabKeyDown = useCallback((index: number) => (event) => {
        let newTab = null;
    ...
    const onMobileKeyDown = useCallback((tabName: string) => (event) => {
    ...
    const onTabStateChange = useCallback((tabId: number, state: Object) => {
