 ...
 * @returns {string}
 */
export function extractFqnFromPath(state) {
    let pathname;
 ...
 * @returns {string}
 */
export async function getDynamicBrandingUrl(stateful) {
 ...
 * @returns {boolean}
 */
export function isDynamicBrandingDataLoaded(state) {
 ...
 * @returns {Object}
 */
export const fetchCustomIcons = async (customIcons) => {
