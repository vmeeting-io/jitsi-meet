 ...
 * @returns {void}
 */
export function sendFaceExpressionToParticipants(conference, faceLandmarks) {
    try {
 ...
 * @returns {void}
 */
export function sendFaceExpressionToServer(conference,
        faceLandmarks) {
    try {
 ...
 */
export async function sendFaceExpressionsWebhook(state) {
 ...
 */
export function getVideoObjectPosition(state, id) {
 ...
 */
export function getDetectionInterval(state) {
