 ...
 */
export function maybeOpenFeedbackDialog(conference, title) {
 ...
 * @returns {Object}
 */
export function openFeedbackDialog(conference, title, onClose) {
 ...
 * @returns {Promise}
 */
export function sendJaasFeedbackMetadata(conference, feedback) {
