 ...
 */
export function getNumberOfPartipantsForTileView(state: Object) {
 ...
 */
export function calculateNonResponsiveTileViewDimensions(state: Object) {
 ...
 * @returns {boolean}
 */
export function showGridInVerticalView(state: Object) {
 ...
 * @returns {number}
 */
export function getVerticalViewMaxWidth(state: Object) {
    const { width } = state['features/filmstrip'];
 ...
 */
export function isFilmstripScrollVisible(state: Object) {
    const _currentLayout = getCurrentLayout(state);
    let hasScroll = false;
 ...
 */
export function getActiveParticipantsIds(state: Object) {
 ...
 */
export function getPinnedActiveParticipants(state: Object) {
    const { activeParticipants } = state['features/filmstrip'];
 ...
 * @returns {boolean}
 */
export function isStageFilmstripAvailable(state: Object, minParticipantCount = 0) {
    const { activeParticipants } = state['features/filmstrip'];
 ...
 * @returns {boolean}
 */
export function isStageFilmstripTopPanel(state: Object, minParticipantCount = 0) {
    const { remoteScreenShares } = state['features/video-layout'];
 ...
 * @returns {boolean}
 */
export function isStageFilmstripEnabled(state: Object) {
    const { filmstrip } = state['features/base/config'];
 ...
 * @returns {boolean}
 */
export function isFilmstripDisabled(state: Object) {
    const { filmstrip } = state['features/base/config'];
 ...
 */
export function getScreenshareFilmstripParticipantId(state: Object) {
 ...
 * @returns {boolean}
 */
export function isTopPanelEnabled(state: Object) {
    const { filmstrip } = state['features/base/config'];
