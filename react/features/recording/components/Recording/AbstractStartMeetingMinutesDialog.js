...
import { setMeetingMinutesState, setSelectedRecordingService, startLocalVideoRecording } from '../../actions';
...
/**
 * Component for the meeting minutes start dialog.
 */
class AbstractStartMeetingMinutesDialog extends Component {
    /**
     * Initializes a new {@code StartMeetingMinutesDialog} instance.
     *
     * @inheritdoc
     */
    constructor(props) {
    ...
    /**
     * Starts a meeting minutes session.
     *
     * @private
    ...
    _onSubmit() {
        ...
        dispatch(setMeetingMinutesState(true));
 ...
 * {@code StartMeetingMinutesDialog} component.
 *
...
export default AbstractStartMeetingMinutesDialog;
