...
import { setMeetingMinutesState, stopLocalVideoRecording } from '../../actions';
...
/**
 * Abstract React Component for getting confirmation to stop a meeting minutes
 * session in progress.
 *
 * @augments Component
 */
export default class AbstractStopMeetingMinutesDialog extends Component {
    /**
     * Initializes a new {@code AbstrStopMeetingMinutesDialog} instance.
     *
     * @inheritdoc
     */
    constructor(props) {
    ...
    /**
     * Stops the meeting minutes session.
     *
     * @private
    ...
    _onSubmit() {
        ...
        this.props.dispatch(setMeetingMinutesState(false));
 ...
 * {@code StopMeetingMinutesDialog} component.
 *
