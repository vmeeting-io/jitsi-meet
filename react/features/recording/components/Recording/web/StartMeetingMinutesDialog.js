...
import AbstractStartMeetingMinutesDialog, {
    mapStateToProps as abstractMapStateToProps
} from '../AbstractStartMeetingMinutesDialog';

import StartMeetingMinutesDialogContent from './StartMeetingMinutesDialogContent';


/**
 * React Component for getting confirmation to start a meeting minutes session in
 * progress.
 *
 * @augments Component
 */
class StartMeetingMinutesDialog extends AbstractStartMeetingMinutesDialog {

    /**
     * Disables start meeting minutes button.
     *
     * @returns {boolean}
     */
    isStartMeetingMinutesDisabled() {
        const {
            isTokenValid,
    ...
    render() {
        ...
        return (
            <Dialog
                ok = {{
                    translationKey: 'dialog.startMeetingMinutes',
                    disabled: this.isStartMeetingMinutesDisabled()
                }}
                onSubmit = { this._onSubmit }
                titleKey = 'dialog.startMeetingMinutes'>
                <StartMeetingMinutesDialogContent
...
export default translate(connect(mapStateToProps)(StartMeetingMinutesDialog));
