...
import AbstractStartMeetingMinutesDialogContent, { mapStateToProps } from '../AbstractStartMeetingMinutesDialogContent';
import {
    DROPBOX_LOGO,
    ICON_CLOUD,
    ICON_INFO,
...
/**
 * The start meeting minutes dialog content for the mobile application.
 */
class StartMeetingMinutesDialogContent extends AbstractStartMeetingMinutesDialogContent {
    /**
    ...
    _renderNoIntegrationsContent() {
        ...
        const label = t('dialog.meetingMinutesDescription');
        ...
        return (
            <Container
                ...
                <label
                    className = 'meeting-minutes-title'
...
export default translate(connect(mapStateToProps)(StartMeetingMinutesDialogContent));
