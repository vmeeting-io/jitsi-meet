...
import DialogWithTabs from '../../../base/ui/components/web/DialogWithTabs';
...
function _mapStateToProps(state, ownProps) {
    ...
    const showShortcutSettings = !Boolean(state['features/base/config'].disableShortcuts);
    ...
    */
    ...
    if (showShortcutSettings && !_iAmVisitor) {
        tabs.push({
