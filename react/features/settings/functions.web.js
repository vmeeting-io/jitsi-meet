 ...
 * dialog.
 */
export function getShortcutsTabProps(stateful, isDisplayedOnWelcomePage) {
 ...
 * dialog.
 */
export function getVirtualBackgroundTabProps(stateful, isDisplayedOnWelcomePage) {
    const state = toState(stateful);
 ...
 */
export function shouldShowModeratorSettings(stateful) {
    const state = toState(stateful);
