...
export const useKeyboardShortcuts = (toolbarButtons: Array<string>) => {
    ...
    const _toolbarButtons = useSelector(
        (state) => toolbarButtons || state['features/toolbox'].toolbarButtons);
    ...
    const fullScreen = useSelector((state) => state['features/toolbox'].fullScreen);
    const participantsPaneOpen = useSelector(getParticipantsPaneOpen);
    const raisedHand = useSelector((state) => hasRaisedHand(getLocalParticipant(state)));
