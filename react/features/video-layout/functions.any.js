 ...
 * @returns {number}
 */
export function getVideoQualityForResizableFilmstripThumbnails(height: number, state: Object) {
    if (!height) {
        return VIDEO_QUALITY_LEVELS.LOW;
    }
 ...
 * @returns {number}
 */
export function getVideoQualityForScreenSharingFilmstrip(height: number, state: Object) {
    if (!height) {
        return VIDEO_QUALITY_LEVELS.LOW;
    }
 ...
 * @returns {number}
 */
export function getVideoQualityForStageThumbnails(height: number, state: Object) {
    if (!height) {
        return VIDEO_QUALITY_LEVELS.LOW;
    }
