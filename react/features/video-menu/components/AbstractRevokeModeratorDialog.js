...
import { revokeModerator } from '../../base/participants'; // should be revoke moderator here
 ...
 */
export default class AbstractRevokeModeratorDialog
    ...
    _onSubmit() {
        ...
        dispatch(revokeModerator(participantID));
