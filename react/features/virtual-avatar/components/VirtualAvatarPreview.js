...
/**
 * The type of the React {@code PureComponent} props of {@link VirtualAvatarPreview}.
 */
export type Props = {
    ...
    /**
     * Dialog callback that indicates if the virtual avatar preview was loaded.
     */
    loadedPreview: Function,

    /**
     * Represents the virtual avatar setted options.
     */
    options: Object,
...
/**
 * The type of the React {@code Component} state of {@link VirtualAvatarPreview}.
 */
type State = {

    /**
     * Loader activated on setting virtual avatar.
     */
    loading: boolean,
 ...
 */
class VirtualAvatarPreview extends PureComponent<Props, State> {
    _componentWasUnmounted: boolean;

    /**
     * Initializes a new {@code VirtualAvatarPreview} instance.
     *
        ...
        try {
            ...
            this.props.dispatch(
                showWarningNotification({
                    titleKey: 'virtualAvatar.virtualAvatarEffectError',
                    description: 'Failed to access camera device.'
                }, NOTIFICATION_TIMEOUT_TYPE.LONG)
            );
            logger.error('Failed to access camera device. Error on apply virtual avatar effect.');
    ...
    /**
     * Apply virtual avatar effect on video preview.
     *
     * @returns {Promise}
     */
 ...
 * {@code VirtualAvatarPreview} component.
 *
...
export default translate(connect(_mapStateToProps)(VirtualAvatarPreview));
